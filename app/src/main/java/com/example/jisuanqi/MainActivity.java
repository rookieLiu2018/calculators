...
public class MainActivity extends AppCompatActivity {
    ...
    private int[] idCal = {R.id.txt_add, R.id.txt_min, R.id.txt_Mul, R.id.txt_chu,R.id.txt_fen,R.id.txt_point};  //运算符
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        output.setText("");
        buttonEqu = (Button)findViewById(R.id.txt_equ);
        ...
        buttonClear = (Button) findViewById(R.id.txt_clear);
        ...
        buttonDel = (Button) findViewById(R.id.txt_back);
